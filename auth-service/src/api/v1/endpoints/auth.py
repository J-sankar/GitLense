...
from src.schemas.auth import (LoginRequest, TokenResponse, RegisterRequest, UserResponse,RegisterResponse)
from src.models.db import User
from src.core.database import get_db
from src.services.auth import register_user, login_user
from src.core.security import get_current_user,decode_token,create_access_token,create_refresh_token,set_refresh_cookies,get_refresh_cookies,verify_refresh_token,delete_refresh_token, save_refresh_token,clear_refresh_cookie
...
async def register(
    ...
    user = await register_user(db=db,username=payload.username, email=payload.email, password=payload.password)
    if user :
