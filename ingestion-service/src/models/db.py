...
class Repo(Base):
    ...
    repo_url       = Column(String(200), nullable=False, unique=True)  
...
class Job(Base):
    ...
    fetched_files = Column(Integer, nullable=True,default=0)
    processed_files = Column(Integer, nullable=True,default=0)
    stored_files  = Column(Integer, nullable=True,default=0)
